...
// pub fn aura_id(env: &Env, owner: &Address) -> Address {
//     env.register(Aura, (owner,))
// }
...
//             expiration: 100,
//             aura: AuraClient::new(&env, &aura_id(&env, &steward_address)),
