...
test("shelter aura", async () => {
  const shelterId = 'CAXFRTR6RGJ76VKLQCPDFVOAXFN5UJ4JKQR6WDWZ353ZV6WI5UWREGGO';
  const steward = Keypair.fromSecret('SA5QDZ6PWTBZ7QHZ2ZTNPUJCCBC6XXL6LTNTYX3QKUS3OL5S676QTWRX');
  const recipient = Keypair.fromSecret('SBMKPHFCDRLFNG2MDQNC34O3FULHZQR6CWH52PLOKBEFB5H2TXUGKV4C');
  const merch = Keypair.fromSecret('SAHFMW6FRJBLOD4TWITVAW6ZLCDNPYUJT5WAM54743SRHMUE6KBXPKHT');
  const sac = new SAC({
      contractId: 'CDVMMBBUXUDPK2BG6SVQMUPNN7BFXZKXO5NHTBFD5KYTW2H5VSHPS3KJ',
      networkPassphrase: Networks.TESTNET,
      rpcUrl: defaultRpc.url(),
